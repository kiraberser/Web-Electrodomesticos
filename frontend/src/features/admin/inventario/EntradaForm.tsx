...
import { registrarEntradaAction } from "@/features/admin/inventario-actions"
import type { Refaccion, Categoria } from "@/features/catalog/api"
import { ArrowDownToLine, X, MapPin } from "lucide-react"
...
export default function EntradaForm({ refacciones, categorias, onSuccess, onCancel }: EntradaFormProps) {
    const { dark } = useAdminTheme()
    const [state, formAction] = useActionState(registrarEntradaAction, { success: false, error: null })
